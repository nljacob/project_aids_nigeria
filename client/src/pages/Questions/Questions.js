    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col">
          ...
          <p>
            ...
            <br />  <br />
            Human: because this virus can only infect human beings. Immuno-deficiency: because the effect of the virus is to create a deficiency, a failure to work properly, within the body’s immune system. Virus: because this organism is a virus, which means one of its characteristics is that it is incapable of reproducing by itself. It reproduces by taking over the machinery of the human cell.
            <br />  <br />
            While AIDS means:
            <br />  <br />
      ...
      <div className="row">
        <div className="col">
          ...
          <br />  <br />
            Administer lab tests to evaluate your immune system. Determine if you have other diseases that might become problematic in the future, including syphilis, TB, hepatitis-B, and toxoplasmosis.
          <br />  <br />
          ...
          <br />  <br />
            Administering vaccines. Many HIV positive people get a hepatitis-B vaccine and bacterial pneumonia vaccines, since contracting these diseases could be dangerous for immune suppressed people. Prescribing antiviral treatments and protease inhibitors when tests show immune system impairment.
          <br />  <br />
